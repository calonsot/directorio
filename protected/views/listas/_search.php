...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'atributos'); ?>
		<?php echo $form->textArea($model,'atributos',array('rows'=>6, 'cols'=>50)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'formatos_id'); ?>
		<?php echo $form->textField($model,'formatos_id'); ?>
	</div>
