...
/**
 * This is the model class for table "tipo_medios".
 *
 * The followings are the available columns in table 'tipo_medios':
 * @property integer $id
 ...
 */
class TipoMedios extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return TipoMedios the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'medioses' => array(self::HAS_MANY, 'Medios', 'tipo_medios_id'),
		);
	}
